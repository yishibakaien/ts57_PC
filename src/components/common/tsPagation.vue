...
<ul class="ts-pagination">
  ...
  <a v-show="totalPages != currentPage && totalPages != 0 " @click="currentPage++ && goto(currentPage++)" :class="{'is-disabled':currentPage<1}">下一页</a>
  <a @click="goto(totalPages)" :class="{'is-disabled':currentPage===totalPages||currentPage<1}" class="ts-pagination--end">尾页</a>
